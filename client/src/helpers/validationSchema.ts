  ...
  yup.object({
    ...
    conditions: yup
      .object({
        fluidIntake: yup
          .number()
          .required(intl.formatMessage({ id: 'form.item.validation.temperature.required' }))
          .nullable(),
        medication: yup.string().nullable(),
        activities: yup.string().nullable(),
        stressLevel: yup.number().required().nullable(),
        stoolPerDay: yup.number().required().nullable(),
        wellbeing: yup.number().required().nullable(),
      })
      .required()
      .nullable(),
    meals: yup.array(
